...
proxy_agent = adk.Agent(
    name="Platform MCP Client Proxy",
    description="Proxies requests to the backend Platform MCP Client Agent on Vertex AI.",
    capabilities={
        "create_post": VertexForwarderCapability(),
        "create_event": VertexForwarderCapability(),
    }
)
