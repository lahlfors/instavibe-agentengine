...
proxy_agent = adk.Agent(
    name="Social Agent Proxy",
    description="Proxies requests to the backend Social Agent on Vertex AI.",
    capabilities={
        "share": VertexForwarderCapability(),
        "get_profile": VertexForwarderCapability(),
        # Add other capabilities as needed, they all use VertexForwarderCapability
    }
)
